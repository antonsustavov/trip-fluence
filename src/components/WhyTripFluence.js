        ...
        <section id='whytripfluence' className="px-4 md:px-6 py-10 sm:py-[60px]">
            <div className='w-full max-w-[1280px] mx-auto'>
                ...
                <div className="flex items-center justify-center gap-3 sm:gap-4">
                    <a href="/creater-account" className="hover:bg-[#4272EE] transition-colors duration-300 bg-[#5383FF] text-white text-sm sm:text-[16px] pt-0.5 font-semibold h-11 sm:h-12 px-5 sm:px-6 rounded-lg flex items-center justify-center">
                        I am Creator
                    </a>
                    <a href="/brands-account" className="hover:bg-[#2A3B6D] transition-colors duration-300 bg-[#1B2B5D] text-white text-sm sm:text-[16px] pt-0.5 font-semibold h-11 sm:h-12 px-5 sm:px-6 rounded-lg flex items-center justify-center">
                        I am Brand
                    </a>
                </div>
            </div>
